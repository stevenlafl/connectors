...
# ---------------------------------------------------------------------------
# Regex: broad case-insensitive match for CONFIDENCE in env var names
#
# Matches any env var containing "CONFIDENCE" (case-insensitive), e.g.:
#   CONNECTOR_CONFIDENCE_LEVEL
#   CONNECTOR_CONFIDENCE
#   MY_CONFIDENCE_SETTING
#
...
# ---------------------------------------------------------------------------
_CONFIDENCE_VAR_RE = re.compile(r"CONFIDENCE", re.IGNORECASE)
